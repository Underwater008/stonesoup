...
using TMPro;
public class xiao23InventorySelect : MonoBehaviour {
  ...
  //public Transform itemSlotTemplate;
    ...
    [SerializeField] private ABX_InventoryUI inventoryUI;

    private ABX_Inventory inventory;
    private void Awake() {

    //itemSlotContainer = transform.Find("itemSlotContainer");
    //itemSlotTemplate = itemSlotTemplate.Find("itemSlotTemplate");
    inventory = new ABX_Inventory();
    inventoryUI.SetInventory(inventory);    //passing inventory object to UI script.
