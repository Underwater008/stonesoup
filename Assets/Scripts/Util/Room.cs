...
public class Room : MonoBehaviour
{
    ...
    [HideInInspector] public int roomVal;
    ...
    public static Room generateRoom(GameObject roomPrefab, LevelGenerator ourGenerator, int roomX, int roomY, int rv, ExitConstraint requiredExits)
    {
